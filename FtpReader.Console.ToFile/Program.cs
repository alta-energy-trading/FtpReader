    ...
    class Program
    {
        ...
        private static async Task Run(IServiceProvider serviceProvider, Options options)
        {
            ...
            FtpConsumerArgs args = new FtpConsumerArgs
            {
                ...
                Password = !string.IsNullOrWhiteSpace(options.Password) ? options.Password : string.IsNullOrWhiteSpace(options.PrivateKeyPath) ? Environment.GetEnvironmentVariables()[options.PasswordEnvironmentVariable].ToString() : "",
